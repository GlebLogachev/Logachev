...
import com.glogachev.developerslife.databinding.FragmentLatestPageBinding
...
class LatestPageFragment : Fragment() {
    ...
    private val viewModel: LatestViewModel by viewModels {
        LatestViewModelFactory(repository = repository)
    }
